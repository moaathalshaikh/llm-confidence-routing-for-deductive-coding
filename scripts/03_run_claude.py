...
Usage:
    # Run all 5 levels
    !python run_claude.py --run_id 1 --api_key YOUR_KEY

    # Run a specific level
    !python run_claude.py --run_id 1 --level L3 --api_key YOUR_KEY

    # Use environment variable
    import os; os.environ["ANTHROPIC_API_KEY"] = "YOUR_KEY"
    !python run_claude.py --run_id 1
"""
...
def call_api(client, prompt: str, attempt: int = 0) -> tuple:
    ...
    pt = msg.usage.input_tokens  if msg.usage else 0
    ct = msg.usage.output_tokens if msg.usage else 0
...
def main():
    ...
    if not api_key: raise ValueError("Provide --api_key or set ANTHROPIC_API_KEY")
